...
for ntest=1:length(SmalFarsdatTestNames)
    ...
    %-------------------------------------------------------------------------
    NetOutputFile=[mainpath,'\ErrorComputation\Error-labelType1\AllOutOne_TrainWithCntk_LabelType1ValidationType1LandmarkType3_NonLandmarkTag\C7-DelFalseIdent\tempTest\Net_',NameTest,'.txt.HLast'];
